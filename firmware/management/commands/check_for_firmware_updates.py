...
class Command(BaseCommand):
    ...
    def process_hotfix_page(self, hotfix_page):
        ...
        fgs = self.create_fgs_from_readme(page_readme[0].text, associated_name)
        for fg in fgs:
        ...
        for download_field in download_fields:
            ...
            if version_number:
                ...
                if created:
                    ...
                    self.new_found_versions.append(new_version)
